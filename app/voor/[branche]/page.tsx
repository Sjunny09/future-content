...
export default function BranchePage() {
  ...
  return (
    <main>
      ...
      <section className="relative bg-[#0F0F0D] overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 pt-32 pb-20 md:pt-40 md:pb-24">
          <motion.div initial="hidden" animate="show" variants={fadeUp}>
            <span className="inline-block text-[#C9A96E] text-xs font-semibold uppercase tracking-[0.2em] mb-7">
              {branche.heroEyebrow}
            </span>
            <h1
              className="text-[#FAFAF8] font-bold leading-[1.04] mb-7 text-[2.6rem] md:text-[4rem] tracking-[-0.02em] max-w-4xl"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
              {branche.heroH1}
            </h1>
            <p className="text-[#FAFAF8]/70 text-lg md:text-xl max-w-2xl mb-9 leading-relaxed">
              {branche.heroLead}
            </p>
      ...
      <section className="bg-[#FAFAF8] py-24 md:py-28">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
            ...
            <h2
              className="text-3xl md:text-[2.4rem] font-bold text-[#1A1A18] mt-4 mb-8 leading-[1.1]"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div
              ...
              className="space-y-5"
            >
              <h3 className="text-sm font-semibold uppercase tracking-[0.15em] text-[#C9A96E]">
                Wel
              </h3>
              <ul className="space-y-4">
                {branche.aiDoetWel.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <Check size={20} className="text-[#1A1A18] mt-0.5 shrink-0" />
            ...
            >
              ...
              <ul className="space-y-4">
                {branche.aiDoetNiet.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <X size={20} className="text-[#6B7280] mt-0.5 shrink-0" />
      ...
      <section className="bg-[#FAFAF8] py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
            ...
            <h2
              className="text-3xl md:text-[2.6rem] font-bold text-[#1A1A18] mt-4 mb-5 leading-[1.1]"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
              {branche.skinTitel}
            </h2>
            <p className="text-[#6B7280] leading-relaxed mb-12 max-w-3xl">{branche.skinLead}</p>
          </motion.div>
          <div className="space-y-10">
            {branche.skinModules.map((m, i) => (
              <motion.div
                ...
                className="border-t border-[#E5E0D8] pt-6"
              >
                <h3 className="text-xl font-semibold text-[#1A1A18] mb-2.5">{m.name}</h3>
                <p className="text-[#6B7280] leading-relaxed max-w-3xl">{m.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#0F0F0D] py-24 md:py-28">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <span className="text-[#C9A96E] text-xs font-semibold uppercase tracking-[0.2em]">
              Eerlijk over de stand
            ...
            <h2
              className="text-3xl md:text-[2.4rem] font-bold text-[#FAFAF8] mt-4 mb-7 leading-[1.1]"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
              {branche.casusStand}
            </h2>
            <div className="space-y-5 text-[#FAFAF8]/70 leading-relaxed">
              <p>{branche.casusBewijs}</p>
              <p className="text-[#FAFAF8]/85">{branche.casusAanbod}</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-[#FAFAF8] py-24 md:py-28 text-center">
        <div className="max-w-3xl mx-auto px-6">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <h2
              className="text-3xl md:text-[2.8rem] font-bold text-[#1A1A18] mb-6 leading-[1.1]"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
            ...
            <Link
              href="/boek"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#1A1A18] text-[#FAFAF8] font-semibold text-lg hover:bg-[#0F0F0D] transition-colors"
            >
