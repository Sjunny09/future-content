import { AI_POSTS_1 } from "./blog/ai-posts-1";
...
export type BlogSection = {
  type: "intro" | "h2" | "p" | "ul" | "quote" | "cta" | "infographic";
  text?: string;
  items?: string[];
  infographic?: string;
};
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    image: "/blog/social-batching.jpg",
  ...
  },
  {
    ...
    image: "/blog/social-vertical.jpg",
  ...
  {
    slug: "trouwen-in-europa-2026",
    image: "/blog/trouwen.jpg",
    title: "Trouwen in Europa in 2026: de mooiste bestemmingen en een videograaf die meekomt",
    date: "2026-03-02",
    excerpt: "Steeds meer Nederlandse stellen kiezen voor een trouwlocatie in Europa. Toscane, de Algarve, Mallorca, Santorini: het kan allemaal. En ik kom graag mee om jullie dag vast te leggen.",
    readTime: "6 min",
    category: "Trouwen",
    content: [
      { type: "intro", text: "Jullie willen trouwen in het buitenland. Misschien al jaren gedroomd van een villa in Toscane, een strand in Portugal of een terras met uitzicht op de Adriatische Zee. De locatie is gevonden, de datum staat vast. Maar wie filmt het? Goed nieuws: ik kom naar jullie toe." },
      { type: "h2", text: "Waarom steeds meer stellen kiezen voor een bruiloft in Europa" },
      { type: "p", text: "Een trouwlocatie in het buitenland biedt iets wat Nederland zelden kan evenaren: licht, landschap en sfeer die van je trouwdag een compleet plaatje maken. De Provençaalse lavendelvelden, de witte kalkstenen muren van Griekenland, het gouden uur boven de Toscaanse heuvels. Die beelden zijn al een verhaal op zich, nog voor de ceremonie begint." },
      { type: "p", text: "Tegelijkertijd groeit het aanbod van mooie locaties, en zijn vluchten vanuit Eindhoven en Amsterdam bereikbaar naar vrijwel heel Europa. Trouwen in het buitenland is niet meer voorbehouden aan een kleine groep, het is een echte keuze geworden voor stellen die iets bijzonders willen." },
      { type: "h2", text: "Populaire bestemmingen in 2026" },
      { type: "ul", items: [
        "Toscane, Italië: de klassieke keuze. Cypressen, wijngaarden, renaissance villa's. Agriturismo's in de heuvels rondom Florence, Siena en San Gimignano bieden een tijdloos decor.",
        "Algarve, Portugal: ruige kliffen, gouden stranden en een warm licht dat de hele dag aanhält. Quinta's in het binnenland combineren rust met grandeur.",
        "Mallorca, Spanje: van rustieke finca's in de Serra de Tramuntana tot strandlocaties met panoramisch zeezicht. Goed bereikbaar, groot aanbod.",
        "Santorini, Griekenland: het iconic witte en blauwe eiland. Zonsondergangen boven de caldera zijn legendarisch. Klein en exclusief trouwen op de rotsen van Oia.",
        "Côte d'Azur, Frankrijk: glamour en grandeur in Zuid-Frankrijk. Villa's met terras, lavendelvelden in de Provence, authentieke Provençaalse dorpjes.",
        "Dubrovnik en Hvar, Kroatië: een opkomende bestemming met spectaculaire ligging aan de Adriatische kust. Oud-Dalmatische stenen muren, kristalhelder water.",
        "Wenen, Oostenrijk: voor stellen die van grandeur houden zonder vliegtuig. Paleizen, tuinen en een stad met karakter, op een paar uur rijden van Nederland.",
      ]},
      { type: "h2", text: "Ik kom naar jullie toe" },
      { type: "p", text: "Als jullie trouwen in het buitenland, is de videograaf een van de laatste dingen waar je aan denkt, maar een van de eersten die je zou moeten regelen. Een lokale videograaf die de taal niet spreekt, jullie niet kent en de sfeer niet begrijpt, levert een generieke video op. Dat verdienen jullie niet." },
      { type: "p", text: "Ik reis mee naar jullie locatie, maak kennis met de sfeer en de plek, en film zoals ik altijd film: rustig, oplettend, zonder opdringerig te zijn. Jullie krijgen een social edit voor Instagram en een lange versie voor privégebruik, binnen vier weken na jullie dag opgeleverd via WeTransfer." },
      { type: "quote", text: "John heeft onze trouwvideo gemaakt, waar wij super tevreden over waren. Hij heeft hele mooie beelden gemaakt, waarvan hij meerdere gave aftermovies van heeft gemaakt. Een fijne man om mee samen te werken." },
      { type: "h2", text: "Praktisch: hoe werkt het?" },
      { type: "ul", items: [
        "Reiskosten worden apart besproken op basis van de locatie en reisduur",
        "We plannen een kennismakingsgesprek om jullie wensen, locatie en planning door te nemen",
        "Ik ben er op de dag zelf van de voorbereidingen tot de receptie",
        "Oplevering binnen vier weken: een social edit van 60 tot 90 seconden en een volledige film voor privégebruik",
        "Muziek naar jullie keuze, professionele audio en kleurgrading",
      ]},
      { type: "h2", text: "Beschikbaarheid in 2026" },
      { type: "p", text: "2026 is voor veel stellen het jaar waarop ze hun uitgestelde droombruiloft eindelijk laten plaatsvinden. Zomerse weekenden in populaire bestemmingen worden snel volgeboekt. Hoe eerder we contact hebben, hoe meer kans dat ik beschikbaar ben op jullie datum." },
      { type: "cta", text: "Trouwen jullie in Europa? Stuur een WhatsApp met jullie datum en locatie, dan kijk ik samen met jullie wat mogelijk is." },
    ],
  },
  {
    ...
    date: "2026-04-14",
    excerpt: "De SLIM-subsidie helpt MKB-bedrijven bij scholing en ontwikkeling van personeel. Ook een AI-training kan daaronder vallen. Dit is wat je moet weten voor je een aanvraag start.",
    readTime: "3 min",
    category: "AI & Content",
    content: [
      { type: "intro", text: "SLIM staat voor Stimuleringsregeling Leren en ontwikkelen In MKB-ondernemingen. Het is een subsidie van de overheid voor bedrijven die willen investeren in de ontwikkeling van hun personeel, en een AI-training kan daar onder omstandigheden onder vallen." },
      ...
      { type: "ul", items: [
        "De regeling kent vaste aanvraagperiodes per jaar, niet doorlopend open. Mis je de periode, dan wacht je op de volgende ronde.",
        "Er is een beperkt subsidieplafond. Op is op, ook binnen een aanvraagperiode.",
        "De aanvraag stelt eisen aan de onderbouwing: waarom deze scholing, voor wie, en wat het oplevert.",
        "Het exacte percentage en maximumbedrag verschilt per aanvraagronde en bedrijfsgrootte. Check dat altijd bij de actuele voorwaarden van RVO, niet bij een oude blogpost.",
      ] },
      { type: "h2", text: "Hoe ik hierin kan helpen" },
      { type: "p", text: "Ik ben geen subsidie-adviseur en beloof geen percentage of bedrag vooraf. Wat ik wel doe: de workshop en training zo beschrijven dat je zelf, of met een subsidie-adviseur, kunt beoordelen of een aanvraag kansrijk is. Twijfel je of jouw situatie past, neem dan gewoon contact op." },
      { type: "cta", text: "Vragen over een training en de SLIM-subsidie? Plan een vrijblijvend gesprek." },
    ],
  },
  ...AI_POSTS_1,
  ...AI_POSTS_2,
